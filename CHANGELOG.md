...
- ci: use commit hash for github action, add persist-credentials false [citest_skip] (#142)
- ci: refactor build_docs so that pandoc runs in isolated read-only job [citest_skip] (#143)
- ci: use exact match for systemroller instead of contains [citest_skip] (#144)
- ci(build_docs): fix pandoc container syntax [citest_skip] (#145)
...
- ci: use gha checkout v7, codecov v7 [citest_skip] (#132)
- ci: Use our own pr_title_lint.py instead of NPM commitlint [citest_skip] (#133)
- ci: bump actions/checkout from 6 to 7 (#134)
- ci: bump tox-lsr version to 3.20.0 to fix tox 4.58 api breakage [citest_skip] (#135)
- ci: Add support for Fedora 44 and drop Fedora 42 - use ansible-core 2.21 [citest_skip] (#137)
- ci: bump actions/setup-python from 6 to 7 (#138)
- ci: ensure dependabot updates do not invoke ci tests [citest_skip] (#139)
...
- ci: bump actions/github-script from 8 to 9 (#127)
- refactor: use ansible.posix 2.1.X for EL7 compatibility [citest_skip] (#128)
- ci: Add config file for CodeRabbit with custom rules (#129)
- ci: Skip reviews for PRs with [citest_skip] in the title (#130)
